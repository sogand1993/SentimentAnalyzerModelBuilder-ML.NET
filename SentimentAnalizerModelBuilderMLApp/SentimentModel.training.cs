...
namespace SentimentAnalizerModelBuilderMLApp
{
    public partial class SentimentModel
    {
        public const string RetrainFilePath =  @"C:\Users\sogan\Downloads\sentiment labelled sentences\sentiment labelled sentences\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=8,NumberOfTrees=98,MaximumBinCountPerFeature=1010,FeatureFraction=0.781891820234752,LearningRate=0.273793647744673,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName: @"col1"))      
